...
For more information, visit: https://github.com/yourusername/gitswitch`);
...
function parseArguments(argv = process.argv) {
  ...
  // If no command was executed, show interactive menu
  if (!result) {
    return { command: 'interactive', args: {}, options: program.opts() };
  }
